...
function App() {
  ...
  return (
    <>
      ...
      <div
        className="w-full flex justify-center xl:px-8 lg:px-44 px-10 md:scroll-mt-50 md:h-auto h-screen py-1 bg-zinc-950"
        ref={servicesRef}
        id="services"
      >
        <div className="bg-zinc-950 text-white poppins md:h-120 flex justify-center gap-16 ">
          <div className="xl:w-150 lg:w-110 md:w-85 flex flex-col justify-center ">
            <div>
              ...
              <p className="text-white font-regular lg:text-lg/tight md:text-start text-center clash">
          ...
          <div className="xl:w-150 lg:w-110 md:w-85 h-full md:flex md:justify-start md:items-center hidden">
            {/*grid maker*/}
            <div className="md:w-full md:h-full md:grid md:grid-cols-2 md:grid-rows-2 md:gap-4 clash">
      ...
      <section
        className="w-screen mb-60 text-white flex justify-center items-center scroll-mt-80 md:h-auto h-1/2"
        ref={aboutRef}
        id="about"
      >
        <div className="xl:w-230 lg:w-250 md:w-170 text-center flex flex-col items-center">
          ...
          <p className="text-white xl:w-230 lg:w-250 md:w-185 md:text-2xl p-10 text-base leading-loose tracking-wider text-center clash">
      ...
      <section
        className="w-screen pb-40 text-white flex justify-center md:scroll-mt-40 scroll-mt-30 h-auto"
        ref={contactRef}
        id="contact"
      >
